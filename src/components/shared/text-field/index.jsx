...
const TextField = forwardRef(
  (
    ...
    const inputBase =
      'absolute top-0 left-0 px-[10px] w-full h-[40px] bg-white font-normal text-[14px] regular-border border-opacity-50 rounded-[5px] transition-all duration-300 ease-in-out outline-none';
